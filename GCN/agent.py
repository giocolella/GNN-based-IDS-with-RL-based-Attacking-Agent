...
class DQNAgent:
    def __init__(self, state_size, action_size):
        ...
        self.memory = deque(maxlen=50000000) #Increasing Memory Size Allows the agent to retain more diverse experiences (less overfitting) for training but Can increase computational cost and memory usage
